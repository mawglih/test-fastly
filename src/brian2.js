...
async function handleRequest(event) {
  ...
  // TEST calling EXTERNAL source (i.e. Maxymiser)
  let prefålightResp = await fetch(
  ...
  //console.log("preflightResp = " + preflightResp.json());
  
  // set ab tests on header for origin
  ...
  //const newReq = new Request(req.url + "anything/" + varyHeaderValue);
